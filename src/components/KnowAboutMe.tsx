...
const KnowAboutMe = () => {
  return (
    <div>
      ...
      >
        <div className="text-center bg-gradient-to-b from-green-700 to-green-600 bg-clip-text text-transparent text-3xl sm:text-4xl md:text-5xl lg:text-7xl xl:text-9xl group-hover:tracking-widest duration-500 ease-out">
          Mahdi Rostami
        </div>
